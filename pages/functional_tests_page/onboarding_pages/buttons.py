...
class OnboardingButtons(BasePage):
    ...
    def tap_continue(self):
        self.clicks.click(self._CONTINUE_BTN)

    def tap_skip(self):
        self.clicks.click(self._SKIP_BTN)

    def tap_get_started(self):
        self.clicks.click(self._GET_STARTED_BTN)

    def tap_add_language_button(self):
        self.clicks.click(self._ADD_LANGUAGE_BTN)

    def tap_add_language_in_list(self):
        self.clicks.click(self._ADD_LANGUAGE_ITEM)

    def tap_navigate_up(self):
        self.clicks.click(self._NAVIGATE_UP_BTN)

    # Visibility checkers
    def is_main_screen_visible(self):
        return self.clicks.is_visible(self._MAIN_SCREEN)

    def is_skip_button_visible(self):
        return self.clicks.is_visible(self._SKIP_BTN)

    def is_get_started_visible(self):
        return self.clicks.is_visible(self._GET_STARTED_BTN)

    def is_continue_button_visible(self):
        return self.clicks.is_visible(self._CONTINUE_BTN)

    def is_add_language_button_visible(self):
        return self.clicks.is_visible(self._ADD_LANGUAGE_BTN)

    def is_add_language_in_list_visible(self):
        return self.clicks.is_visible(self._ADD_LANGUAGE_ITEM)

    def is_navigate_up_visible(self):
        return self.clicks.is_visible(self._NAVIGATE_UP_BTN)